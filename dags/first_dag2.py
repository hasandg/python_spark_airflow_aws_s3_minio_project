...
with DAG(dag_id="first_dag2",
         ...
         default_args={
             ...
             'email': ['hasandaggggg@gmail.com'],
             'email_on_failure': False,
             'email_on_retry': False,
         },
         catchup=False) as dag:

    first_function2 = PythonOperator(
        task_id="first_function",
        python_callable=first_function2,
    )

    email = EmailOperator(
        task_id='send_email',
        to='hasandaggggg@gmail.com',
        subject='Airflow Alert',
        html_content=""" <h3>Email Test Airflow </h3> """,
    )


first_function2 >> email
